...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ActivityType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ActivityType']) ? $this->services['AppBundle\Form\ActivityType'] : ($this->services['AppBundle\Form\ActivityType'] = new \AppBundle\Form\ActivityType())) && false ?: '_'};
}, 'AppBundle\\Form\\AgrupacionType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AgrupacionType']) ? $this->services['AppBundle\Form\AgrupacionType'] : ($this->services['AppBundle\Form\AgrupacionType'] = new \AppBundle\Form\AgrupacionType())) && false ?: '_'};

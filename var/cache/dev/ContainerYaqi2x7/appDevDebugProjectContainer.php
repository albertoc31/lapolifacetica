...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            'appbundle\\controller\\activitycontroller' => 'AppBundle\\Controller\\ActivityController',
            'appbundle\\controller\\defaultcontroller' => 'AppBundle\\Controller\\DefaultController',
            'appbundle\\form\\activitytype' => 'AppBundle\\Form\\ActivityType',
            'appbundle\\form\\agrupaciontype' => 'AppBundle\\Form\\AgrupacionType',
        ...
        $this->fileMap = array(
            'AppBundle\\Controller\\ActivityController' => 'getActivityControllerService.php',
            'AppBundle\\Controller\\DefaultController' => 'getDefaultControllerService.php',
            'AppBundle\\Form\\ActivityType' => 'getActivityTypeService.php',
            'AppBundle\\Form\\AgrupacionType' => 'getAgrupacionTypeService.php',
            ...
            'service_locator.bzuc.og' => 'getServiceLocator_Bzuc_OgService.php',
            'service_locator.iud7pdy' => 'getServiceLocator_Iud7pdyService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\ActivityType' => true,
            'AppBundle\\Form\\AgrupacionType' => true,
            ...
            'service_locator.bzuc.og' => true,
            'service_locator.iud7pdy' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('XSttaUq51+', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WkvwVVLz0l', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('activityImg', 'images/activity_img/');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pjyljy8AJc', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lGqQzjkydc', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hJP39YBFjC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', '/salir', 'logout', '_csrf_token', NULL, NULL);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'activity_img': $value = ($this->targetDirs[3].'/web/images/activity_img'); break;
